...
public class sellerhome extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.print("            <li><a href='Add product'>Add Product</a></li>");
		out.print("            <li><a href=''>View Product</a></li>");
		...
		out.print("    </section>");
		out.print("    <h1 class='pheading' > Products</h1>");
		...
		try 
		{
			...
			ResultSet rs=stmt.executeQuery("select id,image,price from pdt_details where refid='"+id+"'");
			...
			//	System.out.println(base64Image);
			    ...
			    out.print("<a href='changeprice?id1="+rs.getInt("id")+"' class='btn btn-warning'>Change Price </a>");
